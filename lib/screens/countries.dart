...
class _CountriesScreenState extends State<CountriesScreen> {
  ...
  void initVpn() async {
    ...
    List<VpnConfig> listVpn = [
      ...
      VpnConfig(
        config: await rootBundle.loadString('assets/vpn/germany1.ovpn'),
        country: 'Germany',
        countrycode: 'DE',
        username: 'vpn',
        password: 'vpn',
      ...
      VpnConfig(
        config: await rootBundle.loadString('assets/vpn/australia.ovpn'),
        country: 'Australia',
        countrycode: 'AU',
        username: 'vpn',
        password: 'vpn',
      ...
      VpnConfig(
        config: await rootBundle.loadString('assets/vpn/switzerland.ovpn'),
        country: 'SwitzerLand',
        countrycode: 'CH',
        username: 'vpn',
        password: 'vpn',
      ...
      VpnConfig(
        config: await rootBundle.loadString('assets/vpn/uae.ovpn'),
      ...
      VpnConfig(
        config: await rootBundle.loadString('assets/vpn/ukraine.ovpn'),
        country: 'Ukraine',
        countrycode: 'UA',
        username: 'vpn',
        password: 'vpn',
      ...
      VpnConfig(
        config: await rootBundle.loadString('assets/vpn/netherland.ovpn'),
        country: 'NetherLand',
        countrycode: 'NL',
        username: 'vpn',
        password: 'vpn',
